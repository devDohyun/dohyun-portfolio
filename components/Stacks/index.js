        ...
        <div className={style.cards_wrapper}>
          ...
          <div className={style.achievement_card}>
            ...
            <div className={style.item_wrapper}>
              어린 시절부터 컴퓨터와 관련된 직업을 가지고 싶었던 저는, 소프트웨어 특성화 고등학교인 <span className={style.highlight}>세명 컴퓨터고등학교</span>에 진학하여{' '}
              <span className={style.highlight}>스마트 보안솔루션과</span>를 전공하였습니다.
